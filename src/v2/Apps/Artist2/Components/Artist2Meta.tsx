...
import { Artist2MetaCanonicalLinkFragmentContainer } from "./Artist2MetaCanonicalLink"

interface Artist2MetaProps {
  artist: Artist2Meta_artist
}

class Artist2Meta extends Component<Artist2MetaProps> {
  renderImageMetaTags() {
  ...
  render() {
    ...
    return (
      <>
        <Artist2MetaCanonicalLinkFragmentContainer artist={artist} />
